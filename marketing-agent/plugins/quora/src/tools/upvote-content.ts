...
function findVoteButton(direction: 'up' | 'down'): HTMLElement | null {
  ...
  for (const b of allButtons) {
    ...
    if (direction === 'up' && (ariaLabel.includes('upvote') || text.includes('upvote') || svg.innerHTML.includes('caret-up'))) return b as HTMLElement;
    if (direction === 'down' && (ariaLabel.includes('downvote') || text.includes('downvote') || svg.innerHTML.includes('caret-down'))) return b as HTMLElement;
  }
  return null;
}
