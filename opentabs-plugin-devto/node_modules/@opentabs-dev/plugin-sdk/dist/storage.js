 ...
 */
const getWindowLocalStorage = () => window.localStorage;
/**
 ...
 */
export const findLocalStorageEntry = (predicate) => {
 ...
 */
export const getAuthCache = (namespace) => {
    try {
 ...
 */
export const setAuthCache = (namespace, value) => {
    try {
        const g = globalThis;
        if (!g.__openTabs)
            g.__openTabs = {};
 ...
 */
export const clearAuthCache = (namespace) => {
    try {
        const ns = globalThis.__openTabs;
        const cache = ns?.tokenCache;
        if (cache)
