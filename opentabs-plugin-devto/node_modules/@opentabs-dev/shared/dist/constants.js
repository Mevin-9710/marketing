...
export const getConfigDir = () => process.env.OPENTABS_CONFIG_DIR || join(homedir(), '.opentabs');
...
export const getPidFilePath = () => join(getConfigDir(), 'server.pid');
/** Returns the path to the anonymous telemetry ID file (~/.opentabs/telemetry-id). */
export const getTelemetryIdPath = () => join(getConfigDir(), 'telemetry-id');
// ---------------------------------------------------------------------------
 ...
 */
export const pluginNameFromPackage = (pkgName) => {
